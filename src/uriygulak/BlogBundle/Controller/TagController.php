...
class TagController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $tags = $em->getRepository('uriygulakBlogBundle:Tag')->findAll();
    ...
    {
        $tag = new Tag();
        $form = $this->createForm('uriygulak\BlogBundle\Form\TagType', $tag);
    ...
    {
        $deleteForm = $this->createDeleteForm($tag);
        $editForm = $this->createForm('uriygulak\BlogBundle\Form\TagType', $tag);
